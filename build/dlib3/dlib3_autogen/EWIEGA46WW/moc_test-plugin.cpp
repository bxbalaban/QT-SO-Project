/****************************************************************************
** Meta object code from reading C++ file 'test-plugin.h'
**
...
#include <memory>
#include "../../../../dlib3/test-plugin.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#include <QtCore/qplugin.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'test-plugin.h' doesn't include <QObject>."
...
void *TestPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "TestPluginInterface"))
        return static_cast< TestPluginInterface*>(this);
    if (!strcmp(_clname, "whatever.you.want.TestPluginInterface"))
        return static_cast< TestPluginInterface*>(this);
